...
It wraps Baidu AI Search API and Baidu Baike API into a source-first workflow: plan a few targeted queries, collect raw search references, deduplicate them, and write a compact research pack that an agent can cite.
...
For a user-level install, copy `skills/baidu-api-search` into the skills directory used by your agent.
